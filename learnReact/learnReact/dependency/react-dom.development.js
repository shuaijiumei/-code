...
(function (global, factory) {
  ...
  var isArray = Array.isArray; // React.Components uses a shared frozen object by default.
  ...
  function checkClassInstance(workInProgress, ctor, newProps) {
...

    {
      ...
      if (ctor.prototype && ctor.prototype.isPureReactComponent && typeof instance.shouldComponentUpdate !== 'undefined') {
        error('%s has a method called shouldComponentUpdate(). ' + 'shouldComponentUpdate should not be used when extending React.PureComponent. ' + 'Please extend React.Components if shouldComponentUpdate is used.', getComponentName(ctor) || 'A pure components');
      }
...

  {
    ...
    warnForMissingKey = function (child, returnFiber) {
      ...
      if (!(typeof child._store === 'object')) {
        {
          throw Error( "React Components in warnForMissingKey should have a _store. This error is likely caused by a bug in React. Please file an issue." );
        }
      }
...

    {
      if (Component.prototype && typeof Component.prototype.render === 'function') {
        ...
        if (!didWarnAboutBadClass[componentName]) {
          error("The <%s /> components appears to have a render method, but doesn't extend React.Components. " + 'This is likely to cause errors. Change %s to extend React.Components instead.', componentName, componentName);
  ...
  function unstable_renderSubtreeIntoContainer(parentComponent, element, containerNode, callback) {
    ...
    if (!(parentComponent != null && has(parentComponent))) {
      {
        throw Error( "parentComponent must be a valid React Components" );
      }
    }
